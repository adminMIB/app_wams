...
class WeeklyReportControllerLead extends Controller
{
    /**
    ...
    public function index(Request $request)
    {
        ...
        return view('technikalLead.weeklreport.index', compact('weekly_reports', 'data', 'listp'));
    }
    ...
    public function create()
    {
        ...
        return view('technikalLead.weeklreport.create', compact('weekly_reports', 'listp'));
    }
    ...
    public function store(Request $request)
    {
        try {
            ...
            return redirect('tlWeeklyReport')->with('success', 'The Weekly Report has been added');
        } catch (\Exception $r) {
            return redirect('tlWeeklyReport')->with('success', 'The Weekly Report has been added');
        }
    }
