    ...
    <div class="card">
        <div class="card-body">
            ...
            <form action="{{route('updatetml',$time->id)}}" method="post">
                ...
                <input type="hidden" name="list_id[]" value="{{ $tm->id }}">
                <a href="{{route('delete-timeline',$tm->id)}}" class=" btn btn-danger btn-sm " style="float:right;">
                ...
                <div class="mb-2 row">
                    <label for="inputfinish_date" class="col-sm-2 col-form-label">PM</label>
                    <div class="col-sm-10">
                        <input type="text" class="form-control" name="nama_pm[]" value="{{$tm->nama_pm}}" readonly>
                    </div>
                </div>
                ...
                <a href="{{route('timeline')}}" class="btn btn-secondary " style="border-radius: 3em;">Back</a>
