...
@section('content')
    ...
    <form  action="{{route('/adminShowSalesUpdates', $detail->id)}}" method="POST" enctype="multipart/form-data">
        {{csrf_field()}}
        <div class="card">
            ...
            <div class="card-body">
                    ...
                    <div class="mb-2 row">
                        <label for="inputAngka" class="col-sm-3 col-form-label">Engineer & Presales</label>
                        <div class="col-sm-9">
                            <select class="choices  form-select multiple-remove @error('sign_techLead') is-invalid @enderror" multiple="multiple" name="sign_techLead[]">
                                @foreach ($detail->userTechnikalsPipe ?? null as $item)  
                    ...
                    <div class="mb-5 row mt-5">
                      {{-- <label for="inputStatus" class="col-sm-3 col-form-label" style="font-weight: bold">Sign Technikal Terbaru</label>
                      <div class="col-sm-9">
                          <select class="choices form-select multiple-remove @error('sign_techLead') is-invalid @enderror" multiple="multiple" name="sign_techLead[]">
    ...
    <table id="pipeline" class="table d-none table-hover table-responsive">
        <thead>
          <tr>
            ...
            <th>Nama Client</th>
            <th>Nama Project</th>
            <th colspan="2" class="text-center">Produk / Solusi</th>
            ...
            <th>PM</th>
            <th  colspan="5" class="text-center">Technikal</th>
          </tr>
          <tr>
            <th></th>
            <th></th>
