                                    ...
                                    <div class="card-body">
                                        <form class="form">
                                            <div class="row">
                                                ...
                                                <div class="col-md-6 col-12 mb-3">
                                                  <div class="form-group">
                                                      ...
                                                      @foreach ($detailId->userTechnikals as $item)  
                                                        <input type="text" id="email-id-column" class="form-control fw-semibold text-primary"
                                                ...
                                                <div class="col-md-6 col-12 mb-3">
                                                  <div class="form-group">
                                                      <label for="email-id-column">Engineer & Presales</label>
                                                      @foreach ($detailId->userTechnikals as $item)  
                                                        <input type="text" id="email-id-column" class="form-control fw-semibold"
                                                ...
                                                {{-- <div class="col-md-6 col-12 mb-3">
                                                  <div class="form-group">
                                                      <label for="email-id-column">Presales</label>
                                                      @foreach ($detailId->userTechnikals as $item)  
                                                        <input type="text" id="email-id-column" class="form-control fw-semibold"
                                                          name="email-id-column" value="{{$item->userPresale->name ?? null}}">
                                                      @endforeach
                                                  </div>
                                                </div> --}}
                                                <div class="col-md-6 col-12 mb-3">
                                                ...
                                                <div class="d-flex  justify-content-between mt-5">
                                                  ...
                                                  <a href="{{url('/adminprojectShowEdit', $detailId->id)}}" class="btn btn-md btn-danger text-white">Edit</a>
                                                </div>                                            
                                            </div>
                                        </form>
                                    </div>
