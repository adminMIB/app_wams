  ...
  <div class="card">
    ...
    <div class="card-body">
      <form action="{{route('/inputWo/sendPmLead')}}" method="POST" enctype="multipart/form-data">
        ...
        <div class="form-group row">
          <label for="name_user" class="col-sm-3 col-form-label">Kode Project</label>
          <div class="col-sm-9">
            <input type="text" class="form-control" readonly name="kode_project" id="kode_project" value="">
          </div>
        </div>
        <div class="form-group row">
