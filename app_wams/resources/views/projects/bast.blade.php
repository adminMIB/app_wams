...
<div class="section">
  {{-- <nav class="navbar navbar-expand-lg" style="background-color: white; border-radius:15px" >
    ...
    <div class="collapse navbar-collapse" id="navbarNav">
        <ul class="navbar-nav">
        <li class="nav-item ">
            <a class="nav-link  "  href="{{route('detail_project',$bs->id)}}">LTO</a>
        </li>
        <li class="nav-item">
...
<div class="row">
  ...
  <div class="card">
    ...
    <div class="card-body">
        ...
        <div id="exampleModalScrollable{{$bs->id}}" class="modal fade modal-xl" tabindex="-1" role="dialog" aria-labelledby="exampleModalScrollableTitle" aria-hidden="true">
            ...
            <div class="modal-content">
              ...
              <form action="{{route('simpan-data')}}" method="POST" enctype="multipart/form-data">
                ...
                <div class="modal-body">
                  <input type="hidden" name="so_id" value="{{$bs->id}}">
                  <input type="hidden" name="hps" value="{{$bs->estimated_amount}}">
                  <input type="hidden" name="nama_sales" id="" value="{{$bs->amsales}}">
                  <div class="row mb-3">
                      <label for="inputEmail3" class="col-sm-2 col-form-label">No LTO</label>
                      <div class="col-sm-10">
                      <input type="text" class="form-control" name="no_sales" id="inputEmail3" value="{{$bs->no_so}}" readonly>
                      </div>
                  </div>
                  <div class="row mb-3">
                      <label for="inputEmail3" class="col-sm-2 col-form-label">Tanggal LTO</label>
                      <div class="col-sm-10">
                      <input type="text" class="form-control" name="tgl_sales" id="inputEmail3" value="{{$bs->tgl_so}}" readonly>
                      </div>
                  </div>
                  <div class="row mb-3">
                      <label for="inputEmail3" class="col-sm-2 col-form-label">Kode Project</label>
                      <div class="col-sm-10">
                      <input type="text" class="form-control" name="kode_project" id="inputEmail3" value="{{$bs->kode_project}}" readonly>
                      </div>
                  </div>
                  <div class="row mb-3">
                      <label for="inputEmail3" class="col-sm-2 col-form-label">Nama Client</label>
                      <div class="col-sm-10">
                      <input type="text" class="form-control" name="nama_institusi" id="inputEmail3" value="{{$bs->institusi}}" readonly>
                      </div>
                  </div>
                  <div class="row mb-3">
                      <label for="inputEmail3" class="col-sm-2 col-form-label">Nama Project</label>
                      <div class="col-sm-10">
                      <input type="text" class="form-control" name="nama_project" id="inputEmail3" value="{{$bs->project}}" readonly  >
                      </div>
                  </div>
