                ...
                <div class="tab-content" id="myTabContent">
                    <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">                            
                            ...
                            <div class="row mt-2">
                                ...
                                <div class="mr-2 col">
                                    <label for="" class=""><b>Sales Offers</b></label>
                                    <a href="/DocumentLTO/{{$shorder->file_PS}}" class="form-control">{{$shorder->file_PS}}</a>
                                </div>
                            </div>
                        
                            <div>
                                <a href="{{ route('VIEWLTODONE') }}" class="btn btn-secondary mt-2">Back</a>
                            </div>
                            ...
                            <table id="task" class="table table-bordered table-striped table-hover mt-2">
                                ...
                                <tbody>
                                    ...
                                    <tr class="text-center">
                                        ...
                                        <td>{{$shorder->name_user}}</td>
                                        <td>{{$shorder->pmo}}</td>
                                        <td>{{$r->name_technikal}}</td>
                                        <td>{{$r->job_essay}}</td>
                                        <td>
                                            @if ($r->status == 0)
                                            <div class="badge bg-warning">To do</div>
                                            @elseif ($r->status == 1)
                                    ...
                                    <table id="bast" class="table table-bordered  ">
                                        ...
                                        <tbody>
                                            <tr align="center" style="font-size: 13px">
                                                ...
                                                <td>
                                                    <a href="bast_dokumen/{{$r->bast_dokumen}}">{{$r->bast_dokumen}}</a>
                                                </td>
                                            </tr>
                                        </tbody>
                                        @endforeach
