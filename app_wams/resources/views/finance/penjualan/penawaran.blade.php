...
<section class="section">
    <div class="card">
        <div class="card-header d-flex justify-content-between">
            <a href="{{ route('penawaran-Penjualan', $shorder->lto_id) }}" class="btn btn-secondary btn-sm">Back</a>
            <div class="text-end">
                    ...
                    $total = 0;
                        ...
                        {{-- <a href="{{route('penawaran.edit',$i->id)}}">     --}}
                            <tr  style="font-size: 13px;">
                                <td><a href="{{route('penawaran.edit',$i->id)}}">{{$i->nama_barang}}</a></td>
                                <td><a href="{{route('penawaran.edit',$i->id)}}">{{$shorder->kode_project}}</a></td>
                                <td>{{$i->kuantitas}}</td>
                                @if ($i->satuan)
                                <td>{{$i->satuan}}</td>
                                @else
