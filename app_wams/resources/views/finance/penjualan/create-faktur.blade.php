...
<form action="{{route('faktur-store',$shorder->id)}}" method="POST">
    @csrf
    <div class="card">
        <div class="card-body">
            <div class="mb-2 row">
                ...
                <div class="col-sm-2">
                    <select name="mata_uang" id="" class="form-control align-self-center" required>
                        <option value="{{$shorder->mata_uang}}">{{$shorder->mata_uang}}</option>
                ...
                <div class="col-sm-3">
                    <input type="text" class="form-control" name="no_faktur" value="{{ $dd }}/INV-MIB/{{$bln}}/{{$thn}}" readonly required>
                </div>
            </div>
            <div class="mb-3 row">
                <label for="staticEmail" class="col-sm-1 col-form-label" style="font-size: 12px">Date</label>
                <div class="col-sm-3">
                    <input type="date" class="form-control" value="{{$shorder->tgl_penjualan}}" name="tgl_pesanan" required>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="row">
                ...
                <div class="col-md-9">
                    <div class="mb-3 row">
                        ...
                        <div class="col-md-9">
                            <input type="text" class="form-control" value="{{$shorder->nopo}}" name="no_po" id="" required>
                        </div>
                    </div>
                    ...
                    <div class="mb-3 mt-4 row">
                        ...
                        <div class="col">
                            <input class="form-check-input" name="pajak" type="radio" value="Total termasuk Pajak" {{$shorder->pajak=="Total termasuk Pajak"? 'checked':''}} id="flexCheckDefault">
                    ...
                    <div class="mb-2 row">
                        ...
                        <div class="col-md-9">
                            <div class="form-group">
                                <input type="text" class="form-control" name="jenis_dok" required>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-md-9">
                            <input type="date" class="form-control" name="tgl_faktur" id="" required>
                        </div>
                    </div>
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-md-9">
                            <input type="number" class="form-control" name="no_faktur_pajak" id="" required>
                        </div>
                    </div>
                    
                    <div class="mb-3 row">
                        <label for="staticEmail" class="col-md-3 col-form-label" style="font-size: 12px">Adress</label>
                        <div class="col-md-9">
                            <textarea name="alamat" id="" cols="30" class="form-control" required>{{$shorder->alamat}}</textarea>
                        </div>
                    </div>
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-md-9">
                            <input type="text" class="form-control" name="cabang" value="{{$shorder->cabang}}" id="" required>
                        </div>
                    </div>
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-md-9">
                            <input type="date" class="form-control" name="tgl_pengiriman" value="{{$shorder->tgl_pengiriman}}" id="" required>
                        </div>
                    </div>
                    ...
                    <div class="mb-2 row">
                        ...
                        <div class="col-md-9">
                            <div class="form-group">
                                <input type="text" class="form-control" name="pengiriman" value="{{$shorder->pengiriman}}">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="mb-2 row">
                        ...
                        <div class="col-md-9">
                            <div class="form-group">
                                <input type="text" class="form-control" name="syarat_pembayaran" value="{{$shorder->syarat_pembayaran}}" required>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="mb-2 row">
                        ...
                        <div class="col-md-9">
                            <div class="form-group">
                                <input type="text" class="form-control" name="FOB" value="{{$shorder->FOB}}" required>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-md-9">
                            <input type="text" class="form-control" name="end_user" id="" required>
                        </div>
                    </div>
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-md-9">
                            <input type="text" class="form-control" name="attention" id="" required>
                        </div>
                    </div>
                ...
                <div class="col">
                    ...
                    <div class="p-2 mt-3">
                        <a href="{{route('penawaranpesanan',$shorder->id)}}"><button type="button" class="btn btn-secondary w-100 " style="height: 120px"><img src="{{ asset('newassets/assets/images/logo/icons8-back-arrow-50.png') }}" style="color: white" alt="Back"></button></a>
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col-md-9">
                    <div class="mb-3 row">
                        ...
                        <div class="col-md-9">
                            <input type="text" class="form-control" name="npwp" id="">
                        </div>
                    </div>
