...
<section class="section">
    ...
    <form action="{{ route('penawaran.update', $edt->id) }}" method="POST">
        @method('put')
        @csrf
        {{-- @foreach ($edt as $item) --}}
        <div class="card">
            <div class="card-body">
                <div class="mb-2 row">
                    ...
                    <div class="col-sm-3">
                        <input type="text" class="form-control" name="no_penjualan" value="{{ $edt->pp->no_penjualan }}">
                    </div>
                </div>
                <div class="mb-3 row">
            ...
            <div class="card-body">
                <div class="row">
                    <div class="mb-3 row">
                        ...
                        <div class="col-sm-6">
                            <textarea name="alamat" id="" cols="30" class="form-control" readonly>{{$edt->pp->alamat}}</textarea>
                        </div>
                    </div>
