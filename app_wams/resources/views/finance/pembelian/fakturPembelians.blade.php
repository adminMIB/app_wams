...
<section class="section">
    <div class="card">
        <div class="card-header d-flex justify-content-between">
            <a href="{{ route('fakturPembelian', $shorder->lto_id) }}" class="btn btn-secondary btn-sm">Back</a>
            <div class="text-end">
                
                <a href="{{ url('fakturPembelian/create', $shorder->id) }}" class="btn btn-primary btn-sm">Create Faktur</a>
