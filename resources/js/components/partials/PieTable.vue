      ...
      <div class="table-responsive">
        <div class="details-row">
          <table class="table">
            <thead>
              <tr>
                <th style="font-size: 10px;" :class="theme == 'light' ? 'color-theme-light' : 'color-theme-dark'">Nama Penerima</th>
            ...
            <tbody>
              <tr v-for="(detail, idx) in item.details" :key="idx">
                <td :class="theme == 'light' ? 'color-theme-light' : 'color-theme-dark'">{{ detail.nama_tujuan }}</td>
