...
<div class="wrapper">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="../../index3.html" class="brand-link">
      ...
      <span class="brand-text font-weight-light">WAMS</span>
    </a>
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        ...
        <div class="info">
          <a href="#" class="d-block">Management Tools</a>
        </div>
      </div>
            ...
            <div class="row">
              <div class="column col-4">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="no_so" id="exampleInputEmail1" placeholder="No Sales Order">
                </div>
                <div class="form-group">
              ...
              <div class="column col-4">
                ...
                <div class="form-group">
                    ...
                    <select class="form-control select2" style="width: 100%;" name="hps">
                      <option selected="selected">Dok PO</option>
                      <option>Dok Penawaran</option>
                      <option>Dok BAST</option>
                    </select>
                </div>
                <div class="form-group">
...
<?php /**PATH C:\althafrp\backupprjk\aridz\app_aridz\resources\views/index.blade.php ENDPATH**/ ?>