...
class ProjectController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        if (!auth()->user()->can('views')) {
            ...
            $canViewseProjects = auth()->user()->can('views');
            $canCreateProjects = auth()->user()->can('create');
            $canEditProjects  = auth()->user()->can('update');
            $canDeleteProjects  = auth()->user()->can('delete');
            $canApprovelProjects  = auth()->user()->can('approval');
            ...
            return view('dashboard.projects.index', compact('principal', 'customer', 'canViewseProjects', 'canCreateProjects', 'canEditProjects', 'canDeleteProjects', 'canApprovelProjects'));
        }
    }
    ...
    public function update(Request $request, $id)
    {
        if (!auth()->user()->can('update')) {
            return redirect()->back()->with('error', "Dont have access!, 403");
        } else {
    ...
    public function data_incomplete(Request $request)
    {
        ...
        if (!auth()->user()->can('views')) {
            ...
            return view('dashboard.projects.list-incomplete', compact('customer', 'canEditProjects'));
        }
    }
