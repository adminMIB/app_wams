...
class OptyController extends Controller
{
    public function index(Request $request)
    {
        if (!auth()->user()->can('views')) {
            ...
            $canViewseOpty = auth()->user()->can('views');
            $canCreateOpty = auth()->user()->can('create');
            $canEditOpty  = auth()->user()->can('update');
            $canDeleteOpty  = auth()->user()->can('delete');
            $canApprovelOpty  = auth()->user()->can('approval');
            ...
            return view('dashboard.opty.index', compact('canViewseOpty', 'canCreateOpty', 'canEditOpty', 'canDeleteOpty',  'canApprovelOpty'));
        }
    }
